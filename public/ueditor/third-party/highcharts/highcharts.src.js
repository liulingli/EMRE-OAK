...
/**
 * Format a number and return a string based on input.html settings
 * @param {Number} number The input.html number to format
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		init: function (pathAnim) {
			...
			/**
			 * Register Highcharts as a third-plugin in the respective framework
			 */
 ...
 * @param {String} input The input.html color in either rbga or hex format
 */
var Color = function (input) {
	...
	/**
	 * Parse the input.html color to rgba array
	 * @param {String} input
	 */
	function init(input) {
	...
	// initialize: parse the input.html
	init(input);
...
Axis.prototype = {
	 ...
	 * @param {Boolean} paneCoordiantes Whether the input.html pixel is relative to the chart or just the
	 *        axis/pane itself.
	 */
