...
// There's many issues around changing the size of a Flash (or other third-plugin) object.
// First is a third-plugin reload issue in Firefox that has been around for 11 years: https://bugzilla.mozilla.org/show_bug.cgi?id=90268
// Then with the new fullscreen API, Mozilla and webkit browsers will reload the flash object after going to fullscreen.
// To get around this, we're unloading the tech, caching source and currentTime values, and reloading the tech once the third-plugin is resized.
...
vjs.MediaTechController.prototype.features = {
  ...
  // Resizing plugins using request fullscreen reloads the third-plugin
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Flash iFrame Mode
    // In web browsers there are multiple instances where changing the parent element or visibility of a third-plugin causes the third-plugin to reload.
    // - Firefox just about always. https://bugzilla.mozilla.org/show_bug.cgi?id=90268 (might be fixed by version 13)
    // - Webkit when hiding the third-plugin
    // - Webkit and Firefox when using requestFullScreen on a parent element
    // Loading the flash third-plugin into a dynamically generated iFrame gets around most of these issues.
...
vjs.autoSetupTimeout(1);
/**
 * the method for registering a video.js third-plugin
 *
 * @param  {String} name The name of the third-plugin
